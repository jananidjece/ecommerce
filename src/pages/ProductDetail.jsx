  ...
  return (
   ...
   <div className='flex flex-col md:flex-row gap-x-16'>
    ...
    <div className='md:w-1/2 p-4 shadow-md md:p-16 flex flex-col items-center gap-y-2'>
       ...
       <p className='text-x1 font-semibold text-gray-800 mb-4'>${product.price}</p> 
...
Add to cart
   ...
   <div className='mt-8 w-125'>
    <h3 className='text-x1 font-semibold mb-2'>{product.description}</h3>
